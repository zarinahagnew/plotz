...
print(gcf, '-dpdf', '-r150', 'figures/prepre/up_down_separate_prepre.pdf');
...
print(gcf, '-dpdf', '-r150', 'figures/prepre/up_down_together_prepre.pdf');
...
a = axis; axis([tlims4anal a(3:4)]);
goodplot
print(gcf, '-dpdf', '-r150', 'figures/prepre/up_down_separate_2.pdf');
...
print(gcf, '-dpdf', '-r150', 'figures/prepre/finalfigure.pdf');
save prepre
