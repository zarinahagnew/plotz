...
print(gcf, '-dpdf', '-r150', 'figures/up_down_separate.pdf');
...
print(gcf, '-dpdf', '-r150', 'figures/up_down_together.pdf');
...
print(gcf, '-dpdf', '-r150', 'figures/up_down_separate_2.pdf');
...
print(gcf, '-dpdf', '-r150', 'figures/FinalFigureAved.pdf');
